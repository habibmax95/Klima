...
final class EndpointTests: XCTestCase {
    ...
    func testCurrentWeatherByCityNameEndpointIsValid() {
        let endpoint = Endpoint.currentWeatherByCityName(cityName: "stockholm")
        XCTAssertEqual(endpoint.url?.absoluteString, "https://api.openweathermap.org/data/2.5/weather?appid=f1e1e54bd180683469368ad612c7f945&units=metric&q=stockholm", "The endpoint is invalid")
    }
